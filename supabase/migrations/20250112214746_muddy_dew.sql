...
-- Add helpful comment
COMMENT ON FUNCTION handle_subscription_status IS 'Handles subscription status check and updates using stripe_costumer and stripe_subscription tables, selecting the most recently created customer when duplicates exist';